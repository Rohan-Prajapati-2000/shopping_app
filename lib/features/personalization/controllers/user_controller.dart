...
class UserController extends GetxController {
  ...
  void deleteAccountWarningPopup(){
    Get.defaultDialog(
      ...
      middleText: 'Are sure you want to delete your account? This action is not reversible and all of your data will be removed permanently.',
  ...
  void deleteUserAccount() async{
    try{
      SFullScreenLoaders.openLoadingDialog('Processing', SImage.loadingAnimation);
